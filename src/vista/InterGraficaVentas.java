    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < listaCantidad.size(); i++) {
            ...
            if (i == 0) {
                ...
                g.setColor(new Color(119, 136, 153)); // Gris  claro 
            } else if (i == 2) {
                g.setColor(new Color(112, 128, 144)); // Gris pizarra (Slate Gray)
            } else if (i == 3) {
                g.setColor(new Color(95, 158, 160)); // Azul cadete 
            } else if (i == 4) {
                g.setColor(new Color(100, 149, 237)); // Azul maíz 
            } else if (i == 5) {
                g.setColor(new Color(72, 61, 139)); // Azul medio 
            } else if (i == 6) {
                g.setColor(new Color(106, 90, 205)); // Azul medio 
            } else {
                g.setColor(new Color(65, 105, 225)); // Azul real 
            }
