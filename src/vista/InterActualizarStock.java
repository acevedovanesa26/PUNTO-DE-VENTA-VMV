...
public class InterActualizarStock extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setPreferredSize(new java.awt.Dimension(156, 22));
        ...
        jLabel3.setPreferredSize(new java.awt.Dimension(156, 22));
        ...
        jLabel4.setPreferredSize(new java.awt.Dimension(156, 22));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 130, -1));

        txt_cantidad_actual.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txt_cantidad_actual.setEnabled(false);
        txt_cantidad_actual.setPreferredSize(new java.awt.Dimension(156, 22));
        getContentPane().add(txt_cantidad_actual, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 220, -1));

        txt_cantidad_nueva.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txt_cantidad_nueva.setPreferredSize(new java.awt.Dimension(156, 22));
        getContentPane().add(txt_cantidad_nueva, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 220, -1));

        jComboBox_producto.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox_producto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione producto:", "Item 2", "Item 3", "Item 4" }));
        jComboBox_producto.setPreferredSize(new java.awt.Dimension(156, 22));
        jComboBox_producto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox_productoActionPerformed(evt);
            }
        });
        getContentPane().add(jComboBox_producto, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 220, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 220, 30));

        jLabel_wallpaper.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel_wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo3.jpg"))); // NOI18N
        jLabel_wallpaper.setPreferredSize(new java.awt.Dimension(156, 22));
        getContentPane().add(jLabel_wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 470, 270));
