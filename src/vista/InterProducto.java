...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox_iva.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione iva:", "No grava iva", "10%", "19%" }));
        ...
        jComboBox_categoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione proveedor:", "Item 2", "Item 3", "Item 4" }));
    ...
    private void CargarComboCategorias() {
        ...
        try {
            ...
            jComboBox_categoria.addItem("Seleccione Proveedor:");
            while (rs.next()) {
